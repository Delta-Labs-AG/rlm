    ...
    def on_request(self, request: Any, response: Any):
        ...
        if self.on_step:
            ...
            self.on_step({
                ...
                "output": response.chat_completion.response if response.success else response.error,
                "usage": response.chat_completion.usage_summary.to_dict() if response.success else {}
            })
